    ...
    <div className={styles.aboutpagecontainer}>
      ...
      <main className={styles.blogcontainer}>
        ...
        <h1 className={styles.title}>
          Welcome In{" "}
          <a href="https://ranarabees.pythonanywhere.com/">Blogs Page!</a>
        </h1>
        <h1>This Is My {BlogNumber} Blog Page</h1>
      ...
      {/* {rabees.slice(9 , 16).map((curElem) => { */}
        {/* return ( */}
          <div key={rabees.id} className={styles.apimaindiv}>
            <h3>{rabees.id}</h3>
              {/* <Link href={`/blogs/blogsNo${curElem.id}`}> */}
                <h2>{rabees.title}</h2>
                <p>{rabees.body}</p>
                {/* </Link>  */}
          </div>
