    ...
    <div className={styles.aboutpagecontainer}>
      ...
      <main className={styles.aboutcontainer}>
        ...
        <h1 className={styles.title}>
          This is ALL{" "}
          <a href="https://ranarabees.pythonanywhere.com/">About Us!</a>
        </h1>
        ...
        <div className={styles.mythirteen}>
          ...
          <h4>
            <center className={styles.aboutheadtext}>
              {" "}
              <p>^| 👻: About RanVerse Team :👻 |^</p>{" "}
            </center>{" "}
            <p className={styles.aboutpara}>
              We Are full stack <br /> MERN MEAN REACT Native <br /> Windows Mac
              WEB APP ANDROID IOS <br /> Blockchain Metaverse ServerLessAPI &
              Games(2D 3D Unity & Core) developers
            </p>
          </h4>
      ...
      <h1 className={styles.title}>
        My <a href="https://ranarabees.pythonanywhere.com/">Skills!</a>
      </h1>
      <br />
      ...
      />
    <h1 className={styles.title}>
      My <a href="https://ranarabees.pythonanywhere.com/">API !</a>
    </h1>
      <br />
      {rabees.slice(0 , 10).map((curElem) => {
        return (
          <div key={curElem.id} className={styles.apimaindiv}>
            <h3>{curElem.id}</h3>
              <Link href={`/blogs/${curElem.id}`}><h2>{curElem.title}</h2></Link> 
          </div>
        );
      })}
      <footer>
